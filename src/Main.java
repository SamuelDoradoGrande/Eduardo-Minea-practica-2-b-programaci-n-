...
public class Main {
    ...
    public static void main(String[] args) {
        // Ejercicio Util_Modificar.
         class GsonUtilEjemplo_Modificación {
            // Main.
            public static void main(String[] args) {
        ...
        //Ejercicio 1: Las clases correspondientes a cada ejercicio se encuentran debajo de switch.
        switch (args[0]) {
            // Cuaderno 1.1: Clase Circle.
    ...
    public static <T> void guardarObjetoEnArchivo(String rutaArchivo, T objeto) { // Es el metodo para guardar los archivos.
        ...
        try (FileWriter writer = new FileWriter(rutaArchivo)) { // Se crea el escritor de archivos "writer" que escribe en rutaArchivo.
            gson.toJson(objeto, writer); // Pasa el objeto que quieres pasa a JSON en la ruta que se le ha dado a "writer".
        } catch (IOException e) { // Se atrapan las excepción de salida y entrada.
    ...
    static class Circle{ // Corresponde con el Ejercicio 1.cCuaderno 1.1.
        private double radius;
        private String color;

        public Circle(){ // Se crea un constructor predefinido.
            radius = 1.0;
            color = "red";
        }
        public Circle(double radius){ // Se crea un constructor con el parámetro color predefinido.
            this.radius = radius;
            color = "red";
        }
        public Circle(double radius, String color){ // Se crea el constructor de Circle.
            this.radius = radius;
            this.color = color;
        }
        ...
        public double getArea() { // Se retorna el área del circulo.
    ...
    static class MyPoint{ // Corresponde con el Ejercicio 2.2.
        private int x;
        private int y;
    ...
    static class Alumno { // Corresponde con el Ejercicio 2.
    ...
    // Corresponde con el Ejercicio 4.
    ...
    // Ejercicio 1. Cuaderno 3.1.
    public class Main_Test_Circle_Cylinder {
        ...
        public static void main(String[] args) {
            ...
            if (args.length < 2) { // Se comprueba que hay dos argumentos.
                System.out.println("Uso: java -jar programa.jar <operacion> <fichero>");
                return; // Si no los hay, no salimos.
            }

            String operacion = args[0]; // Se organizan operación y archivo con los argumentos.
    ...
    // Ejercicio 1. Cuaderno 3.2.
    public class Main_Test_Point_2D_3D {
        ...
        public static void main(String[] args) {
            ...
            if (args.length < 2) { // Se comprueba que haya dos argumentos.
                System.out.println("Uso: java -jar programa.jar <operacion> <fichero>");
                return; // Si no los hay, nos salimos.
            }
    ...
    // Ejercicio 1. Cuaderno 4.1.
    public class Main_Test_Movable_Point_Circle {

        public interface Movable { // Interface movable.
            void moveUp();
            void moveDown();
            void moveLeft();
            void moveRight();
        ...
        public static class MovablePoint implements Movable { // La clase MovablePoint implementa la interfaz Movable.
            private int x, y;
            ...
            public void moveLeft() {
                x -= xSpeed;
            } // Se mueve el punto desde donde está con una velocidad Speed en el eje x en santido negativo.
            @Override
        ...
        public static class MovableCircle implements Movable { // La clase MovableCircle implementa la interfaz Movable.
        ...
        public static void main(String[] args) {
            ...
            if (args.length < 2) { // Se compruba si tiene dos argumentos.
                System.out.println("Uso: java -jar programa.jar <operacion> <fichero>");
                return; // Si no los tiene, nos salimos.
            }

            String operacion = args[0]; // Se gestionan operación y archivo con los argumentos.
            String rutaArchivo = args[1];
    ...
    // Ejercicio 1. Cuaderno 4.2.
    public class Main_Test_Animal {
    ...
    //// Cita: "La serialización de objetos soporta la codificación de objetos y el objetos accesibles desde ellos, en una secuencia de bytes."
